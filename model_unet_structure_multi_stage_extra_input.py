...
class model:
    ...
    # @staticmethod
    def build_net_2(self, inputs_org, input_fuzzy, class_num, class_weights, train=True):
        with tf.variable_scope("stage2"):
            ...
            with tf.variable_scope("layer1"):
                ...
                inputs = self.concatenate_smaller_images(inputs,input_fuzzy)
            ...
            with tf.variable_scope("layer2"):
                ...
                TD_1 = self.concatenate_smaller_images(TD_1, input_fuzzy)
