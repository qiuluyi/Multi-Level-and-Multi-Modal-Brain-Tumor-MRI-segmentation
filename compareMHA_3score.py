...
base_result_path = '/20210105_01c_2_015training_mha__multi_stage'
if is_fuse:
    result_path = './mhaSavePath' + base_result_path + '/'
else:
    result_path = './mhaSavePath' + base_result_path + '/'
...
for index in range(len(ground_truth_paths)):
    ...
    region3_ppv_avg += region3_ppv
    region3_s = sensitivity_score(dataR3, labelR3)
    region3_s_avg += region3_s
...
print("dice: region1_avg:{} | region2_avg:{} | region3_avg:{}".format(region1_avg/i, region2_avg/i, region3_avg/i))
print("ppv: region1_avg:{} | region2_avg:{} | region3_avg:{}".format(region1_ppv_avg/i, region2_ppv_avg/i, region3_ppv_avg/i))
print("s: region1_avg:{} | region2_avg:{} | region3_avg:{}".format(region1_s_avg/i, region2_s_avg/i, region3_s_avg/i))
